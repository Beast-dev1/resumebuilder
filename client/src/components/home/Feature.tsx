...
export default function Feature() {
  return (
    <section id="features">
      ...
      <Badge text="Feature" variant="green" />
        ...
        <div className="space-y-10 px-4 md:px-0">
          <div className="flex items-center justify-center gap-6 max-w-md">
            ...
            <div className="space-y-2">
              <h3 className="text-base font-semibold text-gray-700">ATS-Friendly Formatting</h3>
              <p className="text-sm text-gray-600">
                Get instant feedback on your resume with real-time ATS compatibility checks and formatting suggestions.
              </p>
            </div>
          </div>
          <div className="flex items-center justify-center gap-6 max-w-md">
            ...
            <div className="space-y-2">
              <h3 className="text-base font-semibold text-gray-700">AI-Powered Content</h3>
              <p className="text-sm text-gray-600">
                Get intelligent content suggestions tailored to your industry with AI that helps you highlight your best achievements.
              </p>
            </div>
          </div>
          <div className="flex items-center justify-center gap-6 max-w-md">
            ...
            <div className="space-y-2">
              <h3 className="text-base font-semibold text-gray-700">Multiple Export Formats</h3>
              <p className="text-sm text-gray-600">
                Export professional, print-ready resumes in PDF, Word, or HTML formats for any application.
              </p>
            </div>
          </div>
        </div>
