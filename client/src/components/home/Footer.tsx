      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm/7 mt-6">
            Resume is a free and powerful resume creation tool with AI-powered
            suggestions, professional templates, and customizable designs to
        ...
        <div>
          ...
          <div className="text-sm space-y-6 max-w-sm">
            <p>
              Get resume tips, career advice, and job search strategies sent to
              your inbox weekly.
            </p>
            <div className="flex items-center">
              <input
                className="rounded-l-md bg-gray-100 outline-none w-full max-w-64 h-11 px-3 focus:ring-2 focus:ring-green-500 focus:bg-white transition"
                type="email"
                placeholder="Enter your email"
              />
              <button className="bg-gradient-to-b from-green-600 to-green-800 cursor-pointer hover:from-green-700 hover:to-green-900 transition px-4 h-11 text-white rounded-r-md font-medium">
                Subscribe
              </button>
            </div>
          </div>
